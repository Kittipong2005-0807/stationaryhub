...
import { Search, Category, ViewModule, ViewList, TrendingUp, LocalShipping, Shield, Star, FilterList, Sort } from "@mui/icons-material"
          ...
          >
            ...
            <Box className="flex flex-wrap justify-center gap-6 mt-8 relative z-10">
              <Box className="flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full">
                ...
                <Typography variant="body2" className="text-white font-medium">Fast Delivery</Typography>
              </Box>
              <Box className="flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full">
                <Shield className="text-white" />
                <Typography variant="body2" className="text-white font-medium">Quality Guaranteed</Typography>
              </Box>
              <Box className="flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full">
                <Star className="text-white" />
                <Typography variant="body2" className="text-white font-medium">Featured Products</Typography>
              </Box>
            </Box>
          </Paper>
        </motion.div>
