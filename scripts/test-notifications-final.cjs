// =====================================================
// ทดสอบระบบการแจ้งเตือนผ่าน Prisma (แก้ไขสุดท้าย)
// =====================================================
...
async function testNotifications() {
  try {
    ...
    // 2. ตรวจสอบข้อมูลสำหรับ user Kittipong (USER_ID: 9C154)
    ...
    console.log('👤 จำนวนการแจ้งเตือนสำหรับ Kittipong (9C154):', kittipongNotifications.length);
    ...
    console.log('\n🎉 จำนวนการแจ้งเตือนหลังจากเพิ่ม:', newNotifications.length);
    console.log('📋 รายการการแจ้งเตือนทั้งหมด:');
